...
[
	...
	["SW Model 500 Magnum", "CSW_M500", 75],
	["M26C Stun Gun", "CSW_M26C", 75],
	["Glock 21SF", "hgun_mas_glocksf_F", 75],
	["Five-seveN USG", "CSW_FN57", 75],
	["Desert Eagle", "CSW_Desert_Eagle", 75],
	["Mk.25", "hlc_pistol_Mk25", 75]
];

smgArray = compileFinal str
[
	["CornerShot System", "CSW_CornerShot", 75],

	["PDW2000 SMG", "hgun_PDW2000_F", 100],
	["Protector SMG", "SMG_05_F", 100],

	//mp5 series here
	["MP5SD6 UW Scuba", "arifle_mas_mp5sd_ds", 100],

	// mp5 by Niarms
	["h&K MP5A2 (TAC)", "hlc_smg_mp5a2_tac", 100],
	["h&K MP5A5 (TAC)", "hlc_smg_mp5N_tac", 100],
	["H&K MP5K-PDW", "hlc_smg_mp5k_PDW", 100],
	["H&K MP5N '9mmAR'", "hlc_smg_9mmar", 100],
	["H&K MP5SD5", "hlc_smg_mp5sd5", 100],

	["Sting SMG", "SMG_02_F", 125],
	["Vermin SMG", "SMG_01_F", 125],
	["MP7A1", "hgun_mas_mp7_F", 125],
	...
	["PS90 w/barrel shroud (olive)", "FHQ_smg_PS90_olive", 150]
];

rifleArray = compileFinal str
[
	// underwater rifle here, mp5 at smgArray
	["AS VAL UW Scuba", "arifle_mas_asval_ds", 200],
	["SDAR Underwater Rifle", "arifle_SDAR_F", 100],
	["Colt M4A1-UW(US-NAVY)", "arifle_mas_usn_SDAR_F", 200],
	["QBZ-95-2 UW(PLA)", "arifle_mas_qbz95_UW", 200],
	...
	["IMI Galil ARM 5.56 (Black)", "FHQ_arifle_Galil_556_black", 250],
	...
	//add G36 by Niarms
	["H&K G36E", "hlc_rifle_G36E1", 150],
	["H&K G36E (GL)", "hlc_rifle_G36E1AG36", 150],
	["H&K G36E ""Romi"" (GL)", "hlc_rifle_G36E1AG36_Romi", 150],
	["H&K G36KE", "hlc_rifle_G36KE1", 150],
	["H&K G36KV", "hlc_rifle_G36KV", 150],
	["H&K G36V", "hlc_rifle_G36V", 150],
	["H&K G36V (GL)", "hlc_rifle_G36VAG36", 150],

	// MXC is Remington ACR or Magpul Masada
	["MXC", "arifle_MXC_F", 150],
	["MXC (Black)", "arifle_MXC_Black_F", 150],
	["MXC (Khaki)", "arifle_MXC_khk_F", 150, "noDLC"],
	["MX Rifle", "arifle_MX_F", 200],
	["MX (Black)", "arifle_MX_Black_F", 200],
	["MX (Khaki)", "arifle_MX_khk_F", 200, "noDLC"],
	["MX 3GL", "arifle_MX_GL_F", 250],
	["MX 3GL (Black)", "arifle_MX_GL_Black_F", 250],
	["MX 3GL (Khaki)", "arifle_MX_GL_khk_F", 250, "noDLC"],

	// add m4a1 by SMA
	["M4A1 Tactical Blk2 SM(VFG)", "SMA_M4MOE_BLK1_SM", 200],
	["M4A1 Tactical Tan(VFG)", "SMA_M4MOE_Tan", 200],
	["M4A1 Tactical OD(VFG)", "SMA_M4MOE_OD", 200],
	["M4A1 Tactical (M203)", "SMA_M4_GL", 200],

	// SPAR-16 is HK416 SPAR-17 is HK417
	...
	//SMA MK18
	/*["MK18 MOD1 SM(VFG)", "SMA_MK18MOE_SM", 450],
	["MK18 MOD1 TAN(VFG)", "SMA_MK18MOETAN", 450],
	["MK18 MOD1 BLK(VFG)", "SMA_MK18MOEBLK", 450],
	["MK18 MOD1 SM(M203)", "SMA_MK18_GL_SM", 450],
	["MK18 MOD1 Tan(M203)", "SMA_MK18TAN_GL", 450],
	["MK18 MOD1 Blk(M203)", "SMA_MK18BLK_GL", 450],*/
	...
	// SCAR by SMA
	["SCAR L STD", "SMA_MK16", 200],
	["SCAR L STD (Black)", "SMA_Mk16_black", 200],
	["SCAR L STD (OD)", "SMA_Mk16_Green", 200],
	["SCAR L STD EGML", "SMA_Mk16_EGLM", 200],
	["SCAR L STD EGML (Black)", "SMA_MK16_EGLM_black", 200],
	["SCAR L STD EGML (OD)", "SMA_MK16_EGLM_Green", 200],

	["SCAR H STD", "SMA_Mk17_16", 200],
	["SCAR H STD (Black)", "SMA_Mk17_16_black", 200],
	["SCAR H STD (OD)", "SMA_Mk17_16_Green", 200],
	["SCAR H CQC EGML", "SMA_Mk17_EGLM", 200],
	["SCAR H CQC EGML (Black)", "SMA_MK17_EGLM_black", 200],
	["SCAR H CQC EGML (OD)", "SMA_MK17_EGLM_Green", 200],
	...
	//L85
	["L85 RIS Stock", "SMA_L85RISNR", 250],
	["L85 RIS", "SMA_L85RIS", 250],
	["L85 RIS (afg) Stock", "SMA_L85RISafgNR", 250],
	["L85 RIS(afg)", "SMA_L85RISafg", 250],

	//LVOA
	["LVOA-C Black 5.56x45mm", "CSW_LVOA_C_Black", 250],
	["LVOA-C Block 5.56x45mm", "CSW_LVOA_C_Block", 250],
	["LVOA-C Green 5.56x45mm", "CSW_LVOA_C_Green", 250],
	["LVOA-C Sand 5.56x45mm", "CSW_LVOA_C_Sand", 250],

	//AUG
	/*["AUG CQC (Black)", "SMA_AUG_A3_F", 250],
	["AUG CQC (Desert)", "SMA_AUG_A3_KRYPT_F", 250],
	["AUG CQC (Olive)", "SMA_AUG_A3_MCAM_F", 250],
	["AUG CQC (Black)", "SMA_AUG_A3_F", 250],
	["AUG CQC (Black)", "SMA_AUG_A3_F", 250],*/

	["Steyr AUGA3 (Black)", "hlc_rifle_auga3_b", 250],
	["Steyr AUGA3 (Blue)", "hlc_rifle_auga3_bl", 250],
	["Steyr AUGA3 (Green)", "hlc_rifle_auga3", 250],
	["Steyr AUGA3 (GL\Black)", "hlc_rifle_auga3_GL_B", 250],
	["Steyr AUGA3 (GL\Blue)", "hlc_rifle_auga3_GL_BL", 250],
	["Steyr AUGA3 (GL\Green)", "hlc_rifle_auga3_GL", 250],
	...
	["R11 RSASS (Black)", "FHQ_srifle_RSASS_Black", 450],
	["R11 RSASS (WDL)", "FHQ_srifle_RSASS_WDL", 450],
	["R11 RSASS (Sand)", "FHQ_srifle_RSASS_Sand", 450],
	["R11 RSASS (Dazzle)", "FHQ_srifle_RSASS_Dazzle", 450],
	["R11 RSASS (Jungle)", "FHQ_srifle_RSASS_Jungle", 450],
	["R11 RSASS (Sand)", "FHQ_srifle_RSASS_Sand", 450],
...
[
	["M14 (Camo)", "srifle_DMR_06_camo_F", 500],
	["M14 (Olive)", "srifle_DMR_06_olive_F", 500],
	["M14 (Classic)", "srifle_DMR_06_hunter_F", 500],
	["M14 EBR", "srifle_mas_ebr", 500],
	...
	["CMR-76-2 camo(PLA)", "arifle_mas_qbz95_csnp", 400],

	["R11 RSASS (Black)", "FHQ_srifle_RSASS_Black", 750],
	["R11 RSASS (Dazzle)", "FHQ_srifle_RSASS_Dazzle", 750],
	["R11 RSASS (Jungle)", "FHQ_srifle_RSASS_Jungle", 750],
	["R11 RSASS (Sand)", "FHQ_srifle_RSASS_Sand", 750],
	["R11 RSASS (WDL)", "FHQ_srifle_RSASS_WDL", 750],
	["R11 RSASS (Winter)", "FHQ_srifle_RSASS_Winter", 750],
	["R11 RSASS (Woodland Netting)", "FHQ_srifle_RSASS_WDLNet", 750],
	...
	["M24", "srifle_mas_m24", 2000],
	["M24 Des", "srifle_mas_m24_d", 2000],
	["M24 Wood", "srifle_mas_m24_v", 2000],

	["MAR-10 Rifle", "srifle_DMR_02_F", 750],
	["MAR-10 Rifle (Camo)", "srifle_DMR_02_camo_F", 750],
	["MAR-10 Rifle (Sand)", "srifle_DMR_02_sniper_F", 750],

	["Remington M2010 ESR (Black)", "FHQ_srifle_M2010_BLK", 2000],
	["Remington M2010 ESR (Desert)", "FHQ_srifle_M2010_DESERT", 2000],
	["Remington M2010 ESR (Desert, worn)", "FHQ_srifle_M2010_WDESERT", 2000],
	["Remington M2010 ESR (Winter)", "FHQ_srifle_M2010_SNW", 2000],
	["Remington M2010 ESR (Woodland)", "FHQ_srifle_M2010_WDL", 2000],

	["M110", "srifle_mas_m110", 2000],
	...
	["FN30-11 (Modernised)", "hlc_rifle_FN3011Modern", 1200],
	["FN30-11 (Modernised/Camo)", "hlc_rifle_FN3011Modern_camo", 1200],
	["FN30-11""Lynx""", "hlc_rifle_FN3011Lynx", 1200],
	...
	["AI AWC-M (Black)", "hlc_rifle_awcovert_BL", 2000],
	["AI AWC-M (FDE)", "hlc_rifle_awcovert_FDE", 2000],
	["AI AWC-M (OD)", "hlc_rifle_awcovert", 2000],

	["AI AWM (Black)", "hlc_rifle_awmagnum_BL", 2000],
	["AI AWM (Black/Ghillie)", "hlc_rifle_awMagnum_BL_ghillie", 2000],
	["AI AWM (FDE)", "hlc_rifle_awmagnum_FDE", 2000],
	["AI AWM (FDE/Ghillie)", "hlc_rifle_awmagnum_FDE_ghillie", 2000],
	["AI AWM (OD)", "hlc_rifle_awmagnum", 2000],
	["AI AWM (OD/Ghillie)", "hlc_rifle_awMagnum_OD_ghillie", 2000],

	["KSVK", "srifle_mas_ksvk", 2000],
	["KSVK Camo", "srifle_mas_ksvk_c", 2000],

	["M107", "srifle_mas_m107", 2000],
	["M107 Des", "srifle_mas_m107_d", 2000],
	["M107 Wood", "srifle_mas_m107_v", 2000],
	["M107", "srifle_mas_m107", 2000],

	["XM109", "srifle_mas_m109", 2000]
];

shotgunsArray = compileFinal str
[
	["Kozlice Shotgun", "sgun_HunterShotgun_01_f", 150],
	["Kozlice Shotgun (Sawed-Off)", "sgun_HunterShotgun_01_sawedoff_f", 75],
	["Benelli M1014", "arifle_mas_m1014", 2000],
	["AA-12", "arifle_mas_aa12", 2000],
	["Remington M870 Express", "CSW_M870", 2000],
	["Saiga-12S", "hlc_rifle_saiga12k", 2000],
	["HK/Olin CAWS", "CSW_CAWS", 2000]
];
...
[
	...
	["M249 Para", "LMG_mas_M249_F", 350],
	["M249 Para Des", "LMG_mas_M249_F_d", 350],
	["M249 Para Wood", "LMG_mas_M249_F_v", 350],

	["Minimi Mk3 7.62 Tactical Long", "sma_minimi_mk3_762tlb", 350],
	["Minimi Mk3 7.62 Tactical Long (Desert)", "sma_minimi_mk3_762tlb_des", 350],
	["Minimi Mk3 7.62 Tactical Long (Woodland)", "sma_minimi_mk3_762tlb_wdl", 350],
	...
	["MG3", "LMG_mas_mg3_F", 1000],
	["M134D 'Epilator'", "HLC_wp_M134Painless", 1000]
];

launcherArray = compileFinal str
[
	["M-79 GL", "arifle_mas_m79", 2000],
	["RPG-7", "launch_RPG7_F", 400],
	["RPG18", "mas_launch_RPG18_F", 400],
	["PZF-60", "mas_launch_pzf60_F", 400],
	["M136 AT-4", "mas_launch_M136_F", 500],
	...
	["SMAW", "mas_launch_smaw_F", 1000],
	["PCML", "launch_NLAW_F", 1000],
	["M3 MAAWS", "mas_launch_maaws_F", 750],
	...
	["ATGM Titan", "mas_launch_TitanS_F", 2000],
	...
	["FIM-92 Stinger", "mas_launch_Stinger_F", 1500],
	["SA-7 Strela", "mas_launch_Strela_F", 1500]
];

allGunStoreFirearms = compileFinal str (call pistolArray + call smgArray + call shotgunsArray + call rifleArray + call lmgArray + call sniperArray + call launcherArray);
...
[
	// grenade (mod)
	//["AN-M14 Increndiary Grenade", "ACE_M14", 50], // Fire
	//["CTS 7290 9-bang Flash Grenade", "ACE_CTS9", 50], // Light
	//["M84 Stun Grenade", "ACE_M84", 50], // Stun?

	// IR grenade (vanilla)
	["IR Designator Grenade", "B_IR_Grenade", 50, "WEST"],
	["IR Designator Grenade", "O_IR_Grenade", 50, "EAST"],
	["IR Designator Grenade", "I_IR_Grenade", 50, "GUER"],

	// Chemlight (mod)
	//["Chemlight (Hi Blue)", "ACE_Chemlight_HiBlue", 25],
	//["Chemlight (Hi Green)", "ACE_Chemlight_HiGreen", 25],
	//["Chemlight (Hi Yellow)", "ACE_Chemlight_HiYellow", 25],
	//["Chemlight (Hi Red)", "ACE_Chemlight_HiRed", 25],
	//["Chemlight (Hi White)", "ACE_Chemlight_HiWhite", 25],
	//["Chemlight (Ultra-Hi Orange)", "ACE_Chemlight_UltraHiOrange", 25],
	...
	["APERS Mine Dispenser", "APERSMineDispenser_Mag", 200],
	...
	["Small IED (Dug-in)", "IEDLandSmall_Remote_Mag", 400],
	["Small IED (Urban)", "IEDUrbanSmall_Remote_Mag", 400],
...
[
	...
	["30Rnd 762x51 RSASS", "FHQ_20Rnd_762x51_Mag", 125], //mod
	["30Rnd 762x51 RSASS (Red Tracer)", "FHQ_20Rnd_762x51_Red_Tracers_Mag", 125], //mod
	["5rnd 7.62mm SD STANAG", "5Rnd_mas_762x51sd_Stanag", 125], // mod
	["5rnd 7.62mm Mag", "5Rnd_mas_762x51_Stanag", 125], // mod
	["5rnd 7.62mm Mag (Tracer)", "5Rnd_mas_762x51_T_Stanag", 125], // mod
	...
	[".408 7Rnd LRR Mag", "7Rnd_408_Mag", 50],
	["12.7mm 5Rnd Mag", "5Rnd_127x108_Mag", 50],
	["12.7mm 5Rnd Armor-Piercing Mag", "5Rnd_127x108_APDS_Mag", 60], // mod
	["12.7mm 10Rnd Subsonic Mag", "10Rnd_127x54_Mag", 75], // mod
	...
	["5rnd 25mm Mag", "5Rnd_mas_25x59_Stanag", 50], // mod
	...
	["12cal Slug AA12", "20Rnd_mas_12Gauge_Slug", 50],
	["12cal Pellets AA12", "20Rnd_mas_12Gauge_Pellets", 50],
	["12cal HE AA12", "20Rnd_mas_12Gauge_Demo", 50],
	["12cal Slug  M1014", "7Rnd_mas_12Gauge_Slug", 50],
	["12cal Pellets  M1014", "7Rnd_mas_12Gauge_Pellets", 50],
	["4Rnd Slug", "CSW_M870_4Rnd_slug", 50],
	["4Rnd Dragon Breath", "CSW_M870_4Rnd_Dagon_Breath", 50],
	["12 Gauge Slug 5Rmd Saiga Mag", "hlc_10rnd_12g_slug_S12", 50],
	["12 Gauge 10Rnd Slug Tungsten", "CSW_CAWS_10Rnd_Slug_Tungsten", 50],
	[".300WM Tracer 5Rnd AWM Mag", "hlc_5rnd_300WM_T_AWM", 50],
	[".300WM Subsonic 5Rnd AWM Mag", "hlc_5rnd_300WM_SBT_AWM", 50],
	[".300WM AP 5Rnd AWM Mag", "hlc_5rnd_300WM_AP_AWM", 50],
	[".300WM FMJ 5Rnd AWM Mag", "hlc_5rnd_300WM_FMJ_AWM", 50],
	["5Rnd 12.7mm Mag(Tracer)", "5Rnd_mas_127x108_T_mag", 50],
	["5Rnd 12.7mm Mag", "5Rnd_mas_127x108_mag", 50],
	["10Rnd 12.7mm Mag", "5Rnd_mas_127x99_Stanag", 50],
	["10Rnd 12.7mm Mag(Tracer)", "5Rnd_mas_127x99_T_Stanag", 50],
	["5Rnd XM2010 .300 Win.", "FHQ_rem_5Rnd_300Win_M2010", 50],
	["MK262 Mod 1 SBLR 5.56mm 30Rnd Tracer Mag", "SMA_30Rnd_556x45_Mk262_Tracer", 50]
];
...
[
	["ACC Evolution 40", "hlc_muzzle_Evo40", 25, "item"],
	["ACC Ti-Rant 9", "hlc_muzzle_TiRant9", 25, "item"],
	["ACC Ti-Rant 9s", "hlc_muzzle_TiRant9S", 25, "item"],
	["SilencerCo. Octane 45s", "hlc_muzzle_Octane45", 25, "item"],
	["Sound Supp NATO Pistols", "muzzle_mas_snds_L", 25, "item"],
	["Sound Supp Rus Pistols", "muzzle_mas_snds_LM", 25, "item"],
	...
	["Pistol Flashlight", "acc_mas_flash_gun", 25, "item"],
	["Pistol IR Pointer", "acc_mas_pointer_gun_IR", 25, "item"],
	["Steiner DBAL-PL (IR)", "hlc_acc_DBALPL", 25, "item"],
	["Steiner DBAL-PL (VIS)", "hlc_acc_DBALPL_FL", 25, "item"],
	["Streamlight TLR-1", "hlc_acc_TLR1", 25, "item"],

	["Yorris J2 (Zubr)", "optic_Yorris", 25, "item"],
	["MRD (4-five/Sand)", "optic_MRD", 25, "item"],
	["MRD (4-five/Black)", "optic_MRD_black", 25, "item", "noDLC"],
	["MRD Black", "optic_mas_MRD", 25, "item"],
	["Doctor Sight II", "HLC_optic_DocterV", 25, "item"],
	["RMR (Handgun)", "RKSL_optic_RMR_HG", 25, "item"],
	["RMR (Handgun) (FDE)", "RKSL_optic_RMR_HG_FDE", 25, "item"],
	["SIG Romeo 1", "HLC_optic_RomeoV", 25, "item"],
	...
	["S+B 5-25x56 PM II", "optic_NVS", 500, "item"],
	
	["S+B 5-25x56 PM II (D)", "optic_NVS", 500, "item"],
	["S+B 5-25x56 PM II (W)", "optic_NVS", 500, "item"],
	["S+B 3-12x50 PM II", "optic_NVS", 500, "item"],
	["S+B 3-12x50 PM II (sunshade)", "optic_NVS", 500, "item"],
	["S+B 3-12x50 PM II (W)", "optic_NVS", 500, "item"],
	["S+B 3-12x50 PM II (D)", "optic_NVS", 500, "item"],
	["S+B 3-12x50 PM II (sunshade) (W)", "optic_NVS", 500, "item"],
	["S+B 3-12x50 PM II (sunshade) (D)", "optic_NVS", 500, "item"],
];
...
[
	...
	["US-NAVY Helmet(NWU t2)", "H_mas_usn_mard_f", 25, "hat"],
	["PLA Helmet SF(urban)", "H_mas_chi_HelmetO_SFd", 25, "hat"],
	["Helmet Mk7 MTP {ESS} (B) [BAF]", "UK3CB_BAF_H_Mk7_Camo_CESS_B", 25, "hat"]
];
...
[
	...
	["PLA Backpack(urban)", "O_mas_chi_Kitbag_d2", 1000, "backpack", "EAST"],
	["PLA AssaultPack(urban)", "O_mas_chi_Kitbag_d", 1000, "backpack", "EAST"],
	["Patrol 01 (KHK)", "milgp_b_patrol_01_khk", 1000, "backpack", "WEST"],
	["Fast Pack(Multi)", "B_mas_Kitbag_mul", 1000, "backpack", "WEST"],
	["Fast Pack(Black)", "B_mas_Kitbag_black", 1000, "backpack", "GUER"],
	["Bergen MTP Rifleman L (A) [BAF]", "UK3CB_BAF_B_Bergen_MTP_Rifleman_L_A", 1000, "backpack", "GUER"]
];
...
[
	...
	// ace items
	// ["MicroDAGR GPS", "ACE_microDAGR", 150, "item"],
	// ["HuntIR monitor", "ACE_HuntIR_monitor", 150, "item"],
	// ["Earplugs", "ACE_ATragMX", 150, "item"],
	...
	// night vision (mod)
	// ["NVG PVS-7(Flip Up)", "NVGoggles_mas_ohv", 150, "nvg", "WEST"],
	// ["PLA NVG PVS-7", "NVGoggles_mas_chi_H", 150, "nvg", "EAST"],
	// ["Head-Mounted NV System [BAF]", "UK3CB_BAF_HMNVS", 150, "nvg", "GUER"],
	["GPNVG-18", "NVGoggles_mas_18", 150, "nvg"],
	...
	// binoculars (mod)
	["Laser Designator B\W", "Laserdesignator_mas_h", 150, "binoc"], // Laser, Auto Rangefinder, [Daylight,FLIR Black & White, Night Vision]
	["AN/PEQ-1 SOFLAM", "UK3CB_BAF_Soflam_Laserdesignator", 1500000, "binoc"], // Laser, Auto Rangefinder, [Daylight, FLIR Green, Night Vision]
	// ["MX-2A", "ACE_MX2A", 1000000, "binoc"], // [FLIR Black & White]
	["Rangefinder Ti", "Rangefinder_mas_h", 15000000, "binoc"], // Manual Rangefinder, [Daylight, FLIR Black & White, Night Vision]
...
[
	...
	["Camoflage Vehicle Cover", "CamoNet_BLUFOR_big_F", 250, "object"],
	...
	["Street Lamp (Small)", "Land_LampStreet_small_F", 100, "object"],
	["Street Lamp", "Land_LampStreet_F", 100, "object"],
	...
	["Modular Bunker (Block)", "Land_Bunker_01_blocks_1_F", 750, "object"],
	["Modular Bunker (3 Blocks)", "Land_Bunker_01_blocks_3_F", 2000, "object"],
	...
	["Industrial Shed", "Land_i_Shed_Ind_F", 2000, "object"],
	["Military Cargo House (Green)", "Land_Cargo_House_V1_F", 1500, "object"],
	["Military Cargo House (Brown)", "Land_Cargo_House_V3_F", 1500, "object"],
	["Military Cargo Post (Green)", "Land_Cargo_Patrol_V1_F", 1500, "object"],
	["Military Cargo Post (Brown)", "Land_Cargo_Patrol_V3_F", 1500, "object"],
	["Military Cargo HQ (Green)", "Land_Cargo_HQ_V1_F", 2000, "object"],
	["Military Cargo HQ (Brown)", "Land_Cargo_HQ_V3_F", 2000, "object"],
	["Military Cargo Tower (Green)", "Land_Cargo_Tower_V1_F", 6000, "object"],
	["Military Cargo Tower (Brown)", "Land_Cargo_Tower_V3_F", 6000, "object"],
	["Modular Bunker (Small)", "Land_Bunker_01_small_F", 3000, "object"],
	["Modular Bunker (HQ)", "Land_Bunker_01_HQ_F", 5000, "object"],
	["Modular Bunker (Tall)", "Land_Bunker_01_tall_F", 8000, "object"],
...
[
	...
	["Wiesel 2 RFCV (Radar)", "I_LT_01_scout_F", 5000, "vehicle"],
	...
	["M4 Scorcher", "B_MBT_01_arty_F", 150000, "vehicle"],
	["M5 Sandstorm MLRS", "B_MBT_01_mlrs_F", 175000, "vehicle"],
	["2S9 Sochor", "O_MBT_02_arty_F", 150000, "vehicle"],
	["Zamak MRL", "I_TRUCK_02_MRL_F", 125000, "vehicle"]
];
...
[
	...
	["Apache AH1", "UK3CB_BAF_Apache_AH1_DynamicLoadout", 8000, "vehicle"],
	["Apache AH1 AT", "UK3CB_BAF_Apache_AH1_AT", 8000, "vehicle"],
	["Apache AH1 Multi JS", "UK3CB_BAF_Apache_AH1_JS", 8000, "vehicle"],
	["Apache AH1 CAS", "UK3CB_BAF_Apache_AH1_CAS", 8000, "vehicle"],
	...
	["AH-6 Little Bird (Gun-Only)", "B_Heli_Light_01_dynamicLoadout_F", 15000, "vehicle", "variant_pawneeGun"], // Armed AH-6 (no missiles)
	["AH-6 Little Bird", "B_Heli_Light_01_dynamicLoadout_F", 35000, "vehicle", "variant_pawneeNormal"], // Armed AH-6
...
[
	...
	// ["A-10C Thunderbolt II", "USAF_A10", 60000, "vehicle"],
	// ["F-22 Raptop", "USAF_F22", 60000, "vehicle"],
	// ["F-35A Lightning II", "USAF_F35A", 60000, "vehicle"],
	// ["F/A-18 E Super Hornet", "JS_JC_FA18E", 60000, "vehicle"],
	...
	["MQ-9 Reaper", "UK3CB_BAF_MQ9_Reaper", 50000, "vehicle"]
...
[
	...
	["Offshore Raiding Craft HMG", "UK3CB_BAF_RHIB_HMG", 6500, "boat"],
	["Offshore Raiding Craft GPMG", "UK3CB_BAF_RHIB_GPMG", 6500, "boat"],
...
turretsArray = compileFinal str
[
	["AN/MPQ-105 Radar", "B_Radar_System_01_F", 500, "vehicle"],
	["MIM-145 Defender", "B_SAM_System_03_F", 500, "vehicle"],
	["R-750 Cronus Radar", "O_Radar_System_02_F", 500, "vehicle"],
	["S-750 Rhea", "O_SAM_System_04_F", 500, "vehicle"],
	["Praetorian 1C", "B_AAA_System_01_F", 500, "vehicle"],
	["MK21 Centurion", "B_SAM_System_02_F", 500, "vehicle"],
	["MK41 VLS", "B_Ship_MRLS_01_F", 500, "vehicle"],
	["MK45 Hammer", "B_Ship_Gun_01_F", 500, "vehicle"],
	["MK49 Spartan", "B_SAM_System_01_F", 500, "vehicle"]
];

allVehStoreVehicles = compileFinal str (call landArray + call armoredArray + call tanksArray + call helicoptersArray + call planesArray + call turretsArray + call boatsArray);
...
[
	["Artillery Strike", "artillery", localize "STR_WL_ShopDescriptions_Artillery", "client\icons\tablet.paa", 500000, 100000],
	...
	["Energy Drink", "energydrink", localize "STR_WL_ShopDescriptions_Energy_Drink", "client\icons\energydrink.paa", 100, 50, "HIDDEN"],
	["Warchest", "warchest", localize "STR_WL_ShopDescriptions_Warchest", "client\icons\warchest.paa", 1000, 500],
	["Quadbike", "quadbike", localize "STR_WL_ShopDescriptions_QuadBike", "\A3\Soft_F\Quadbike_01\Data\UI\Quadbike_01_CA.paa", 750, 250],
	["Water Scooter", "waterscooter", localize "STR_WL_ShopDescriptions_WaterScooter", "\A3\Boat_F_Exp\Scooter_Transport_01\Data\UI\Scooter_Transport_01_CA.paa", 750, 250]
];
