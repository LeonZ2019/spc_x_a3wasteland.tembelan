...
_setupObjects =
{
	...
	_vehicles =
	[
		[_veh1, _missionPos vectorAdd ([[random 50, 0, 00], random 360] call BIS_fnc_rotateVector2D), 0] call _createVehicle,
		[_veh2, _missionPos vectorAdd ([[random 50, 0, 00], random 360] call BIS_fnc_rotateVector2D), 0] call _createVehicle
	];
	...
	_missionHintText = format ["A formation of Jets containing two <t color='%3'>%1</t> are patrolling the island. Destroy them and recover their cargo!", _vehicleName, _vehicleName2, militaryMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "The sky is clear again, the enemy patrol was taken out! Ammo crates and some money has fallen near the pilot.";
};
