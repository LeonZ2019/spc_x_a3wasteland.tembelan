...
_setupObjects =
{
	...
	_heliChoices =
	[
		["UK3CB_BAF_Merlin_HC3_18_GPMG", ["B_Heli_Light_01_dynamicLoadout_F", "pawneeNormal"]],
		["UK3CB_BAF_Merlin_HC3_18_GPMG", ["O_Heli_Light_02_dynamicLoadout_F", "orcaDAGR"]],
		["UK3CB_BAF_Merlin_HC3_18_GPMG", "I_Heli_light_03_dynamicLoadout_F"]
	];

	if (missionDifficultyHard) then
	{
		(_heliChoices select 0) set [0, "UK3CB_BAF_Apache_AH1_DynamicLoadout"];
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "UK3CB_BAF_Merlin_HC3_18_GPMG"):
			{
...
_veh = createVehicle ["O_Heli_Light_02_dynamicLoadout_F",position player,[],0,"NONE"];
[
	_veh,
	["Black",1], 
	true
