...
// Rifleman
_man6 = _group createUnit ["C_man_polo_6_F", [(_pos select 0) + 10, _pos select 1, 0], [], 1, "Form"];
...
// Rifleman
_man7 = _group createUnit ["C_man_polo_5_F", [(_pos select 0) + 10, _pos select 1, 0], [], 1, "Form"];
