...
if (_success) then {
	...
	if (MF_ITEMS_SPAWN_BEACON call mf_inventory_is_full) then {
		MF_ITEMS_SPAWN_BEACON call mf_inventory_drop;
		["You already have Spawn Beacon so dropped the beacon",5] call mf_notify_client;
	} else {
